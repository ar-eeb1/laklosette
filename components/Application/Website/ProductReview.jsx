...
const ProductReview = ({ productId }) => {
    ...
    const [curretnUrl, setCurretnUrl] = useState('')
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            setCurretnUrl(window.location.href)
        }
    }, [])
            ...
            <div className='p-4'>
                <div className='flex justify-between flex-wrap items-center'>
                    <div className='md:w-1/2 w-full md:flex md:gap-10 md:mb-0 mb-5'>
                        <div className='md:w-[200px] w-full md:mb-0 mb-5'>
                            ...
                            <p className='text-center mt-3'>
                                ({reviewCount?.totalReview} Reviews)
                            </p>
                        </div>
                    ...
                    <div className='md:w-1/2 w-full md:text-end text-center'>
                        <Button onClick={() => setIsReview(!isReview)} type='button' className={`md:w-fit w-full py-6 px-10 cursor-pointer hover:bg-primary transition duration-300`} variant='outline'>Write Review</Button>
                    </div>
                </div>

                {isReview &&

                    <div className=' mt-5 shadow bg-gray-200/20 border p-5 rounded-lg'>
                        ...
                        {!auth
                            ...
                            <>
                                ...
                                <Button type='button' asChild>
                                    <Link href={`${WEBSITE_LOGIN}?callback=${curretnUrl}`}>
                                        Login
                                    </Link>
                                </Button>
                            </>
                                ...
                                <Form {...form}>
                                    <form onSubmit={form.handleSubmit(handleReviewSubmit)}>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel>Title</FormLabel>
                                                        <FormControl>
                                                            <Textarea placeholder='Write Review..' {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                        ...
                                        <div className='mb-3 w-full'>
                                            <ButtonLoading loading={loading} type="submit" text="Submit Review" className="text-center cursor-pointer " />
                                        </div>
                ...
                <div className='mt-10 border-t pt-5'>
                    ...
                    <div className='mt-10'>
                        ...
                        {hasNextPage &&
                            <ButtonLoading className='cursor-pointer' loading={isFetching} onClick={fetchNextPage} text={'load more '} type={`button`}></ButtonLoading>}
                    </div>
                </div>
            </div>
        </div>
