  ...
  return (
    <div>
      ...
      <div className='lg:px-40 px-5 py-20'>
        ...
        <p>Welcome to our store, your one-stop destination for quality, convenience, and innovation in online shopping.</p>
        ...
        <ul className='list-disc ps-10 mt-3'>
          <li> <b> Customer Satisfaction:</b> Your happiness is our priority. From browsing to checkout, we are here to make your shopping experience effortless and enjoyable.</li>
        ...
        <p className='mt-3'>As a growing brand, we believe in constantly evolving—adding new products, improving our services, and listening to what our customers want. Whether you're shopping for yourself or finding the perfect gift, we are here to help you discover something you'll love.
        </p>
        <p className='mt-3'>
          Thank you for choosing our store. Lets make shopping smarter, simpler, and more enjoyable—together.
        </p>
      </div>
    </div>
  )
