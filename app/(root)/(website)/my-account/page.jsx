...
function MyAccount() {
  ...
  const { data: dashbaordData } = useFetch('/api/dashboard/user')
          ...
          <div className='p-5'>
            <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-10 gap-5'>
              <div className='flex items-center justify-between gap-5 border rounded p-3'>
                <div>
                  ...
                  <span className='font-semibold text-gray-500'>{dashbaordData?.data?.totalOrder || 0}</span>
                </div>
              ...
              <div className='flex items-center justify-between gap-5 border rounded p-3'>
                ...
                <div className='w-16 h-16 bg-primary rounded-full flex justify-center items-center'>
                  <IoCart className='text-white ' size={25} />
                </div>
              </div>
            ...
            <div className='mt-5'>
              ...
              <table className='w-full'>
                ...
                <tbody>
                  {dashbaordData && dashbaordData?.data?.recentOrders?.map((order, i) => (
                    <tr key={order._id}>
